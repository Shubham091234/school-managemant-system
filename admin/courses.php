  ...
  if(isset($_POST['submit']))
  {
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["thumbnail"]["tmp_name"], $target_file)) {
        mysqli_query($db_conn, "INSERT INTO courses (`name`, `category`, `duration`,`image`, `date`,`Price`) VALUES ('$name', '$category', '$duration', '$image', '$today','$Price')") or die(mysqli_error($db_conn));
